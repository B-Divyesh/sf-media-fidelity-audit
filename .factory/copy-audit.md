...
| Live Photo pairs | 3 |
| 1 | 1 |
| Files in the sample | 4 |
| beach-live.HEIC — identical | 3 |
| beach-live.MOV — identical | 3 |
...
| Questions | 1 |
| Open the GitHub source repository (external) | 6 |
| Compare source folders with local media archives. | 7 |
| Privacy | 1 |
| Terms | 1 |
| Source on GitHub (external) | 4 |
...
| Hashes establish byte equality. | 4 |
| They do not establish image quality or fitness for a purpose. | 11 |
| You are responsible for choosing the correct source and archive folders. | 11 |
| Compare source folders with local media archives. | 7 |
| Privacy | 1 |
| Terms | 1 |
| Source on GitHub (external) | 4 |
